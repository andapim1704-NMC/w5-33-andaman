    ...
    <SafeAreaView style={Styles.uiSAV}>
      ...
      >
        <View style={Styles.uiV1}>
          <Text style={Styles.uiText3}>ดอกเบี้ยง่าย</Text>

          <TextInput
            style={Styles.uiTI1}
            placeholderTextColor={"#000000"}
            placeholder="กรอกเงินต้น"
            onChangeText={(e) => setP(Number(e))}
          />
          <TextInput
            style={Styles.uiTI1}
            placeholderTextColor={"#000000"}
            placeholder="กรอกอัตรา"
            onChangeText={(e) => setR(Number(e))}
          />
          <TextInput
            style={Styles.uiTI1}
            placeholderTextColor={"#000000"}
            placeholder="กรอกเวลา"
            onChangeText={(e) => setT(Number(e))}
          />
