    ...
    <SafeAreaView style={Styles.uiSAV}>
      ...
      >
        <View style={Styles.uiV1}>
          <Text style={Styles.uiText3}>พื้นที่สี่เหลี่ยมคางหมู</Text>

          <TextInput
            style={Styles.uiTI1}
            placeholderTextColor={"#000000"}
            placeholder="กรอกด้านหน้า"
            onChangeText={(e) => setL1(Number(e))}
          />
          <TextInput
            style={Styles.uiTI1}
            placeholderTextColor={"#000000"}
            placeholder="กรอกด้านหลัง"
            onChangeText={(e) => setR1(Number(e))}
          />
          <TextInput
            style={Styles.uiTI1}
            placeholderTextColor={"#000000"}
            placeholder="กรอกความสูง"
            onChangeText={(e) => setH1(Number(e))}
          />
